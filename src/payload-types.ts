...
export interface Config {
  ...
  collectionsSelect: {
    ...
    tournament: TournamentSelect<false> | TournamentSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tournament_select".
 */
export interface TournamentSelect<T extends boolean = true> {
  badgeText?: T;
  date?: T;
  registrationLink?: T;
  updatedAt?: T;
